			...
			<div class="col-lg-11 mb-5">
				<div class="left-news">
					<h2 class="font-weight-bold text-center">
						<font color="#146C94">&nbsp; View Add Coupon Details</font>
					</h2>
				...
				<div class="border border-top-3 border-danger">
					<div class="panel grey lighten-5 border ">
						<h6 class="font-weight-normal pt-1 pl-1">Info : View Coupon Details</h6>
						<hr>
							...
							<div class="table table-responsive">
								<div class="table table-responsive">
									<table class="table table-bordered table-hover" width="100%">
										...
										<?php $page_name = "view_coupon.php"; //  If you use this code with a different page ( or file ) name then change this 
										...
										$query = "SELECT * FROM coupons order by id desc limit $eu, $limit ";
										...
										?>
											<tbody>
												<tr>
													...
													<td width="100">
														<center>
															<a class="text-decoration-none" onclick="return confirm('Are you sure you want to delete this Data ?')" href="view_coupon.php?del=<?php echo $id; ?>"> <img src="img/delete.png" width="15"> </a> | <a style="font-size:10px;padding:3px 3px;background:#1a8646;color:#fff;" href="update_coupon.php?id=<?php echo $id; ?>">Edit</a>
														</center>
													</td>
												</tr>
											</tbody>
								...
								<div class="col-lg-12 col-xl-12">
									<div class="pp" style="margin-left:0px;">
										<center>
											<?php
											$query = "select count(id) from coupons order by id desc";
...
if (isset($_GET['del'])) {
	...
	$d = "delete from coupons where id = '$id' ";

	$del = mysqli_query($con, $d);
	if ($del) {
		header("location:view_coupon.php?d=1");
		exit();
	}
}
?>
...
?>
		<script>
			alert("coupon Detail is Deleted Successfully!!!");
		</script>
<?php
	}
}
...
?>
		<script>
			alert("Coupon Detail is Updated Successfully!!!");
		</script>
<?php
	}
}
