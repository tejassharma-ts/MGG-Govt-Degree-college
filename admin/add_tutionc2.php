...
{	
	...
	mysqli_query($con,"insert into `tutioncat2_tb`(`id`,`sub_name`) values (NULL,'$sub_name')");
	
	header("location:add_tutionc2.php?ADD=1");
...
<?php
 ...
 ?>
 <script>
 alert("Subject is successfully Added..");
 </script>
 <?php
 }
 }
        ...
        <div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-lg-12 col-xl-12">
					<div class="">
						<h1 class="font-weight-bold mt-5" style="font-size:20px;"><font class="font-1">Add</font><font class="font-2">&nbsp;Subject Category</font></h1>
						<p>Internship Time</p>
					</div>
				</div>
				<!--./head-->
								...
								<form action="" method="post" enctype="multipart/form-data" autocomplete="off" >		
									<div class="col-lg-12">
										<div class="form-group ">
											...
											<input class="form-control tt" type="text" name="sub_name" placeholder="Enter Class Name" required="required" />
										</div><!--form-group-->
									</div>
...
$query = "SELECT * FROM tutioncat2_tb order by id desc limit $eu, $limit ";
...
?> 
										<tbody>
											<tr> 
												...
												<td width="100">
													<center>
														<a onclick="return confirm('Are you sure you want to remove this Form ?')" href="add_tutionc2.php?del=<?php echo $id; ?>" title="Delete"> <img src="img/delete.png" width="15"> </a> | <a href="update_tutionc2.php?id=<?php echo $id; ?>"><img src="img/edit.png" width="20"> </a>
													</center>
												</td>
											</tr>
										</tbody>
...
<center>
<?php
$query = "select count(id) from tutioncat2_tb order by id desc";
...
if($back >=0) { 
print "<a href='$page_name?id=$sub_name&start=$back&limit=$limit' style='margin-right: 0px;color:white;text-decoration: none;'><font face='Verdana' size='2'><span class='label label-default' style='background-color: #2bbbad;'><</span></font></a>"; 
} 
...
if($i <> $eu){
echo " <a href='$page_name?id=$sub_name&start=$i&limit=$limit' style='color:black;'><font face='Verdana' size='2'><span class='label label-danger'>$l</span></font></a> ";
}
...
if($this1 < $nume) { 
print "<a href='$page_name?id=$sub_name&start=$next&limit=$limit' style='color:black;text-decoration: none;'><font face='Verdana' size='2'><span class='label label-default'style='background-color: #2bbbad;'>></span></font></a>";} 
?>	
</center>	
</div><!--pp-->
							</div>
...
if(isset($_GET['del'])){
    ...
    $d = "delete from tutioncat2_tb where id = '$id' ";
	
    $del = mysqli_query($con,$d);
	if($del){		
       header("location:add_tutionc2.php?d=1");
	   exit();
	}
}
?>
