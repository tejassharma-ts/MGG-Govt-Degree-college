...
<?php
$id = $_GET['id'];
$q = "select * from hobbycat_tb where id='$id' ";
...
{	
	...
	header("Location:add_hobbyc.php?u=1");
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-lg-12 col-xl-12">
					<div class="">
						<h1 class="font-weight-bold mt-5" style="font-size:20px;"><font class="font-1">Update</font><font class="font-2">&nbsp;Hobby Category</font></h1>
						<p>Internship Time</p>
					</div>
				</div>
				<!--./head-->
								...
								<form action="" method="post" enctype="multipart/form-data" autocomplete="off" >
									<div class="col-lg-12">
										<div class="form-group ">
											...
											<input class="form-control tt" type="text" autofocus name="hobby_name" Value="<?php echo $hobby_name;?>" required="required" />
										</div><!--form-group-->
									</div>
