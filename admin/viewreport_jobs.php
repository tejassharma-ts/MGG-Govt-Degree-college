...
/////////// Now let us print the table headers ///////////////*/
                                    ...
                                    $query = "SELECT * FROM sjobreg_tb order by id desc limit $eu, $limit ";
                            ...
                            <div class="col-lg-12 col-xl-12 all">
                                <div class="pp" style="margin-left:0px;">
                                    <center>
                                        <?php
                                        $query = "select count(id) from sjobreg_tb order by id desc";
