			...
			<div class="col-lg-11 mb-5">
				<div class="left-news">
					<h2 class="font-weight-bold text-center">
						<font color="#146C94">&nbsp; View Jobs</font>
					</h2>
				...
				<div class="border border-top-3 border-danger">
					<div class="panel grey lighten-5 border ">
						<h6 class="font-weight-normal pt-1 pl-1">Info : View Jobs </h6>
						<hr>
						<div class="panel-body p-4">
							<div class="table table-responsive">
								...
								<table class="table table-bordered table-hover" width="100%">
									...
									<?php $page_name = "viewjob.php"; //  If you use this code with a different page ( or file ) name then change this 
									...
									$query = "SELECT * FROM addjob_tb order by id desc limit $eu, $limit ";
									...
									?>
										<tbody>
											<tr>
												...
												<td><?php echo $exp_year; ?> <?php echo $exp_months; ?></td>
												...
												<td width="100">
													<center>
														<a onclick="return confirm('Are you sure you want to remove this Form ?')" href="viewjob.php?del=<?php echo $id; ?>"> <img src="img/delete.png" width="15"> </a> | <a style="font-size:10px;padding:3px 3px;background:#1a8646;color:#fff;" href="viewjob_details.php?id=<?php echo $id; ?>">View</a>
													</center>
												</td>
											</tr>
										</tbody>
							...
							<div class="col-lg-12 col-xl-12">
								<div class="pp" style="margin-left:0px;">
									<center>
										<?php
										$query = "select count(id) from addjob_tb order by id desc";
...
if (isset($_GET['del'])) {
	...
	$d = "delete from addjob_tb where id = '$id' ";

	$del = mysqli_query($con, $d);
	if ($del) {
		header("location:viewjob.php?d=1");
		exit();
	}
}
?>
