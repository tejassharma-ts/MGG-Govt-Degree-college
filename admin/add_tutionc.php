        ...
        <div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-lg-12 col-xl-12">
					<div class="">
						<h1 class="font-weight-bold mt-5" style="font-size:20px;"><font class="font-1">Add</font><font class="font-2">&nbsp;Class Category</font></h1>
						<p>Internship Time</p>
					</div>
				</div>
				<!--./head-->
...
?> 
										<tbody>
											<tr> 
												...
												<td width="100">
													<center>
														<a onclick="return confirm('Are you sure you want to remove this Form ?')" href="add_tutionc.php?del=<?php echo $id; ?>" title="Delete"> <img src="img/delete.png" width="15"> </a> | <a href="update_tutionc.php?id=<?php echo $id; ?>"><img src="img/edit.png" width="20"> </a>
														</center>
												</td>
											</tr>
										</tbody>
