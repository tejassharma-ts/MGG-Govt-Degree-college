        ...
        <div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-lg-12 col-xl-12">
					<div class="box-1">
						<div class="box-2">
							<h6 class="text-1">Info : Registered Students</h6> <hr>
							<div class="box-3">
...
<?php $page_name="view_student.php"; //  If you use this code with a different page ( or file ) name then change this 
...
?> 
										<tbody>
											<tr> 
												...
												<td width="100">
													<center>
														<a onclick="return confirm('Are you sure you want to remove this Form ?')" href="view_student.php?del=<?php echo $id; ?>"> <img src="img/delete.png" width="15"> </a> |	<a style="font-size:10px;padding:3px 3px;background:#1a8646;color:#fff;" href="view_student_details.php?id=<?php echo $id; ?>">View</a>
													</center>
												</td>
											</tr>
										</tbody>
...
if(isset($_GET['del'])){
    ...
    $d = "delete from sreg_tb where id = '$id' ";
