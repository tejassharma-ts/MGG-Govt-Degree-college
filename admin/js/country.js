...
var country_arr = new Array("Afghanistan", "Albania", "Algeria", "American Samoa", "Angola", "Anguilla", "Antartica",
    "Antigua and Barbuda", "Argentina", "Armenia", "Aruba", "Ashmore and Cartier Island", "Australia", "Austria",
    ...
    "Micronesia, Federated States of", "Midway Islands", "Moldova", "Monaco", "Mongolia", "Montserrat", "Morocco",
    ...
    "Samoa", "San Marino", "Sao Tome and Principe", "Saudi Arabia", "Scotland", "Senegal", "Seychelles",
...
s_a[252] =
    ...
    function populateStates(countryElementId, stateElementId) {
        ...
        // Add the "Select State" option with an empty value at the beginning
        var selectStateOption = new Option('Select State', '');
        selectStateOption.disabled = true;
    

        stateElement.options[stateElement.length] = selectStateOption;
    
        // If a country is selected, populate the states dropdown
        if (selectedCountryIndex >= 0) {
            ...
            // Hide the "Select State" option after a country is selected
            selectStateOption.style.display = 'none';
        } else {
            // If no country is selected, set the "Select State" option as selected
            selectStateOption.selected = true;
        }
    }
    ...
    function populateCountries(countryElementId, stateElementId) {
        ...
        // Add the "Select Country" option with a value of -1 at the beginning
        var selectCountryOption = new Option('Select Country', '-1');
        selectCountryOption.disabled = true;
        selectCountryOption.selected = true;
        countryElement.options[countryElement.length] = selectCountryOption;
        ...
        // Initialize states dropdown with "Select State" option
        populateStates(countryElementId, stateElementId);
    }
    
    // Call populateCountries to initialize the country dropdown
