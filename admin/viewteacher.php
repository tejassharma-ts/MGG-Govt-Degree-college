							...
							<div class="table table-responsive">
								<div class="table table-responsive">
									<table class="table table-bordered table-hover" width="100%">
										...
										<?php $page_name = "viewteacher.php"; //  If you use this code with a different page ( or file ) name then change this 
										...
										$query = "SELECT * FROM faculty_members order by id desc limit $eu, $limit ";
										...
										?>
											<tbody>
												<tr>
													...
													<td><?php echo $name; ?></td>
													<td><img src="<?php echo $photo; ?>" height="100px" width="100px" alt=""></td>
                                                <td class=""><?php echo !empty($email) ? $email : "Not provided"; ?></td>
                                                <td><?php echo $position; ?></td>
												<td>
                                                    <?php if (!empty($cv_path)): ?>
                                                    <a href="<?php echo $cv_path ?>" download>Download the CV</a>
                                                    <?php endif; ?>
                                                </td>
                                                <td width="100">
														<center>
															<a class="text-decoration-none" onclick="return confirm('Are you sure you want to delete this Data ?')" href="viewteacher.php?del=<?php echo $id; ?>"> <img src="img/delete.png" width="15"> </a> | <a style="font-size:10px;padding:3px 3px;background:#1a8646;color:#fff;" href="updateteacher.php?id=<?php echo $id; ?>">Edit</a>
														</center>
													</td>
												</tr>
											</tbody>
...
if (isset($_GET['del'])) {
	...
	$d = "delete from faculty_members where id = '$id' ";

	$del = mysqli_query($con, $d);
	if ($del) {
		header("location:viewteacher.php?d=1");
		exit();
	}
}
?>
...
?>
		<script>
			alert("Teacher Detail is Deleted Successfully!!!");
		</script>
<?php
	}
}
...
?>
		<script>
			alert("Teacher Detail is Updated Successfully!!!");
		</script>
<?php
	}
}
