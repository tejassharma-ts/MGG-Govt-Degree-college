...
<?php 
$id = $_GET['id'];
$q = "select * from cinternreg_tb where id='$id' order by id desc ";
                    ...
                    <div class="col-lg-12 col-xl-12">
                        <div class="">
                            <h1 class="font-weight-bold mt-5" style="font-size:20px;">
                                ...
                                <font class="font-2">&nbsp;Internship Registered Company</font>
                            </h1>
                            <p>Internship Time</p>
                        </div>
                    </div>
                        ...
                        <div class="box-1">
                            <div class="box-2">
                                <h6 class="text-1">Info : Registered Company |
                                    <a style="color:white;"
                                        href="updateintern_regcompany.php?id=<?php echo $id; ?>">Edit&nbsp;
                                        <i class="fa fa-edit" style="font-size:18px"></i></a>
                                </h6>
                                <hr>
                                <div class="box-3"><a href="viewintern_regcompany.php" class="btn btn-primary">Back</a>
                                    <div class="table table-responsive">
                                        <table class="table table-hover" width="100%">
                                            <thead>
                                                ...
                                                <tr>
                                                    <th>Official Logo</th>
                                                    <td><img src="upload/<?php echo $img; ?>" width="200px"
                                                            height="200px" alt=""></td>
                                                </tr>
                                                <tr>
                                                    <th>Password</th>
