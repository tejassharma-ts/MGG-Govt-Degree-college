...
{	
	...
	mysqli_query($con,"UPDATE `tutioncat2_tb` SET `sub_name`='$sub_name' WHERE id='$id' ");
        ...
        <div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-lg-12 col-xl-12">
					<div class="">
						<h1 class="font-weight-bold mt-5" style="font-size:20px;"><font class="font-1">Update</font><font class="font-2">&nbsp;Subject Category</font></h1>
						<p>Internship Time</p>
					</div>
				</div>
				<!--./head-->
