            ...
            <div class="col-lg-11 mb-5">
                <div class="left-news">
                    <h2 class="font-weight-bold text-center">
                        <font color="#146C94">&nbsp; View Company Internship Report</font>
                    </h2>
                    <h6 class="fw-bold">InternshipTime</h6>
                </div>
                <div class="border border-top-3 border-danger">
                    <div class="panel grey lighten-5 border p-3">
                        <h6 class="font-weight-normal pt-1 pl-1">Info : Company Internship Report</h6>
                        <hr>
                        <div class="panel-body p-4">
                            <div class="table table-responsive row">
                                ...
                                <table class="table table-bordered table-hover all" width="100%">
                                    ...
                                    <?php $page_name = "viewreport_internc.php"; /*/  If you use this code with a different page ( or file ) name then change this */
