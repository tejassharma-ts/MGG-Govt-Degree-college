...
{   $hotid = $_POST['hotid']; 
	echo "update creg_tb set hot='1' where id='".$hotid."'";
	mysqli_query($con,"update creg_tb set hot='1' where id='".$hotid."'");
...
if(isset($_POST['hot']))
{   $hotid = $_POST['hotid']; 
    echo "update creg_tb set hot = '0' where id='".$hotid."'";
	mysqli_query($con,"update creg_tb set hot = '0' where id='".$hotid."'");
	if($con){
	mysqli_query($con,"update creg_tb set hot = '0' where id='".$hotid."'");
	//mysqli_query($con,"update creg_tb set `date_time` =  '000-00-00 00:00:00' where id='".$hotid."'");
	}	
    header("location:view_company.php");
	exit();	
}
        ...
        <div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-lg-12 col-xl-12">
					<div class="">
						<h1 class="font-weight-bold mt-5" style="font-size:20px;"><font class="font-1">View</font><font class="font-2">&nbsp;Registered Company</font></h1>
						<p>Internship Time</p>
					</div>
				</div>
				<!--./head-->
				<div class="col-lg-12 col-xl-12">
					<div class="box-1">
						<div class="box-2">
							<h6 class="text-1">Info : Registered Companys</h6> <hr>
							<div class="box-3">
...
<?php $page_name="view_company.php"; //  If you use this code with a different page ( or file ) name then change this 
...
$query = "SELECT * FROM creg_tb order by id desc limit $eu, $limit ";
...
?> 
										<tbody>
											<tr> 
												...
												<td width="100">
													<center>
														<a onclick="return confirm('Are you sure you want to remove this Form ?')" href="view_company.php?del=<?php echo $id; ?>"> <img src="img/delete.png" width="15"> </a> |	<a style="font-size:10px;padding:3px 3px;background:#1a8646;color:#fff;" href="view_company_details.php?id=<?php echo $id; ?>">View</a>
													</center>
												</td>
											</tr>
										</tbody>
...
<center>
<?php
$query = "select count(id) from creg_tb order by id desc";
...
if($back >=0) { 
print "<a href='$page_name?id=$cname&start=$back&limit=$limit' style='margin-right: 0px;color:white;text-decoration: none;'><font face='Verdana' size='2'><span class='label label-default' style='background-color: #2bbbad;'><</span></font></a>"; 
} 
...
if($i <> $eu){
echo " <a href='$page_name?id=$cname&start=$i&limit=$limit' style='color:black;'><font face='Verdana' size='2'><span class='label label-danger'>$l</span></font></a> ";
}
...
if($this1 < $nume) { 
print "<a href='$page_name?id=$cname&start=$next&limit=$limit' style='color:black;text-decoration: none;'><font face='Verdana' size='2'><span class='label label-default'style='background-color: #2bbbad;'>></span></font></a>";} 
?>	
</center>	
</div><!--pp-->
</div>
...
if(isset($_GET['del'])){
    ...
    $d = "delete from creg_tb where id = '$id' ";
	
    $del = mysqli_query($con,$d);
	if($del){		
       header("location:view_company.php?d=1");
	   exit();
	}
}
?>
