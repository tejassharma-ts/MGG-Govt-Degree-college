						...
						<div class="panel-body p-4">
							<div class="table table-responsive">
								<table class="table table-bordered table-hover" width="100%">
									...
									$query = "SELECT * FROM companyreg order by id desc limit $eu, $limit ";
									...
									?>
										<tbody>
											<tr>
												...
												<td width="100">
													<center>
														<a onclick="return confirm('Are you sure you want to remove this Form ?')" href="view_regcompany.php?del=<?php echo $id; ?>"> <img src="img/delete.png" width="15"> </a> | <a style="font-size:10px;padding:3px 3px;background:#1a8646;color:#fff;" href="view_company_details.php?id=<?php echo $id; ?>">View</a>
													</center>
												</td>
											</tr>
										</tbody>
							...
							<div class="col-lg-12 col-xl-12">
								<div class="pp" style="margin-left:0px;">
									<center>
										<?php
										$query = "select count(id) from companyreg order by id desc";
