                ...
                <div class="col-lg-6 col-md-10">
                    <div class="card card-default mb-0">
                        ...
                        <div class="card-body px-5 pb-5 mt-4">
                            ...
                            <h4 class="text-dark mb-6 text-center">ADMIN Register</h4>

                            <form action="register_get.php" method="post" autocomplete="off">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <button name="btn1" type="submit" class="btn btn-primary btn-pill mb-4">Register</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
