...
if(isset($_POST['post1']))
{
	...
	mysqli_query($con,"insert into `jobcat_tb`(`id`,`jobcat_name`) values (NULL,'$jobcat_name')");
...
<?php
 ...
 ?>
 <script>
 alert("Job Category is successfully Added..");
 </script>
 <?php
 }
 }
        ...
        <div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-lg-12 col-xl-12">
					<div class="">
						<h1 class="font-weight-bold" style="font-size:20px;"><font class="font-1">Add</font><font class="font-2">&nbsp;Job Category</font></h1>
						<p>VellaPantii</p>
					</div>
				</div>
				<!--./head-->
				...
				<div class="col-lg-8 col-xl-8">
					<div class="box-1">
						<div class="box-2">
							<h6 class="text-1 ">Info : job Category Name</h6> <hr>
							<div class="box-3">
...
$query = "SELECT * FROM jobcat_tb order by id desc limit $eu, $limit ";
...
?> 
										<tbody>
											<tr> 
												...
												<td width="100">
													<center>
														<a onclick="return confirm('Are you sure you want to remove this Form ?')" href="add_jobc.php?del=<?php echo $id; ?>" title="Delete"> <img src="img/delete.png" width="15"> </a> | 
														
														
														  <a href="#<?php echo $id;?>" data-toggle="modal" data-target="#modalLoginForm<?php echo $id;?>"><img src="img/edit.png" width="20" ></a>
										...
										<div class="modal fade" id="modalLoginForm<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header text-center">
			<h4 class="modal-title w-100 font-weight-bold" id="exampleModalLabel">Job Category</h4>
			<button type="button" class="close" data-dismiss="modal" aria-label="Close">
			  <span aria-hidden="true">&times;</span>
			</button>
		  </div>
	<form action="update_jobc.php" method="post">
		  <div class="modal-body mx-3">
			<div class="md-form mb-5">
			  <label data-error="wrong" data-success="right" for="defaultForm-email">Job Category</label>
			  <input type="hidden" name="id" value="<?php echo $id; ?>" class="form-control">
			  <input type="text" id="defaultForm-email" class="form-control tt" name="jobcat_name" value="<?php echo $jobcat_name; ?>">
			</div>
		  </div>
