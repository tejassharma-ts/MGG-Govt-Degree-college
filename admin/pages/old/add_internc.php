...
if(isset($_POST['post1']))
{
	...
	mysqli_query($con,"insert into `interncat_tb`(`id`,`intren_name`) values (NULL,'$intren_name')");
        ...
        <div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-lg-12 col-xl-12">
					<div class="">
						<h1 class="font-weight-bold" style="font-size:20px;"><font class="font-1">Add</font><font class="font-2">&nbsp;Internship Category</font></h1>
						<p>VellaPantii</p>
					</div>
				</div>
				<!--./head-->
								...
								<form action="" method="post" enctype="multipart/form-data" autocomplete="off" >
									<div class="col-lg-12">
										<div class="form-group ">
											...
											<input class="form-control tt" type="text" name="intren_name" placeholder="Enter Internship Name" required="required" />
										</div><!--form-group-->
									</div>
				...
				<div class="col-lg-8 col-xl-8">
					<div class="box-1">
						<div class="box-2">
							<h6 class="text-1 ">Info : Internship Name</h6> <hr>
							<div class="box-3">
...
$query = "SELECT * FROM interncat_tb order by id desc limit $eu, $limit ";
...
{	
	$id = $row['id'];
	$intren_name = $row['intren_name'];
?> 
										<tbody>
											<tr> 
												<td><?php echo $id; ?></td>
												<td><?php echo $intren_name; ?></td>
												<td width="100">
													<center>
														<a onclick="return confirm('Are you sure you want to remove this Form ?')" href="add_internc.php?del=<?php echo $id; ?>" title="Delete"> <img src="img/delete.png" width="15"> </a> | 
	...
	<form action="update_internc.php" method="post">
	<div class="modal fade" id="<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
	  aria-hidden="true">
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header text-center">
			<h4 class="modal-title w-100 font-weight-bold">Update Internship</h4>
		  ...
		  <div class="modal-body mx-3">
			<div class="md-form mb-5">
			  <label data-error="wrong" data-success="right" for="defaultForm-email">Internship Name</label>
			  <input type="hidden" name="id" value="<?php echo $id; ?>" class="form-control">
			  <input type="text" id="defaultForm-email" class="form-control tt" name="intren_name" value="<?php echo $intren_name; ?>">
			</div>
		  </div>
...
if($back >=0) { 
print "<a href='$page_name?id=$intren_name&start=$back&limit=$limit' style='margin-right: 0px;color:white;text-decoration: none;'><font face='Verdana' size='2'><span class='label label-default' style='background-color: #2bbbad;'><</span></font></a>"; 
} 
...
if($i <> $eu){
echo " <a href='$page_name?id=$intren_name&start=$i&limit=$limit' style='color:black;'><font face='Verdana' size='2'><span class='label label-danger'>$l</span></font></a> ";
}
...
if($this1 < $nume) { 
print "<a href='$page_name?id=$intren_name&start=$next&limit=$limit' style='color:black;text-decoration: none;'><font face='Verdana' size='2'><span class='label label-default'style='background-color: #2bbbad;'>></span></font></a>";} 
?>	
</center>	
</div><!--pp-->
							</div>
