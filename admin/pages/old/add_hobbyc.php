...
?> 
										<tbody>
											<tr> 
												...
												<td width="100">
													<center>
														<a onclick="return confirm('Are you sure you want to remove this Form ?')" href="add_hobbyc.php?del=<?php echo $id; ?>" title="Delete"> <img src="img/delete.png" width="15"> </a> | 
		...
		<div class="modal-content">
		  ...
		  <div class="modal-body mx-3">
			<div class="md-form mb-5">
			  <label data-error="wrong" data-success="right" for="defaultForm-email">Hobby Name</label>
			  <input type="hidden" name="id" value="<?php echo $id; ?>" class="form-control">
			  <input type="text" id="defaultForm-email" class="form-control tt" name="hobby_name" value="<?php echo $hobby_name; ?>">
			</div>
		  </div>
