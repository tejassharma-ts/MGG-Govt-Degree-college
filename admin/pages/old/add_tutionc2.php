...
{	
	...
	mysqli_query($con,"insert into `tutioncat2_tb`(`id`,`cat_name`,`sub_name`) values (NULL,'$cat_name','$sub_name')");
	
	header("location:add_tutionc2.php?a=1");
								...
								<form action="" method="post" enctype="multipart/form-data" autocomplete="off" >
									<div class="col-lg-12">
										<div class="form-group ">
											...
											<select name="cat_name" class="form-control" required="required" style="width: 98%;" >
...
?> 
										<tbody>
											<tr> 
												...
												<td width="100">
													<center>
														<a onclick="return confirm('Are you sure you want to remove this Form ?')" href="add_tutionc2.php?del=<?php echo $id; ?>" title="Delete"> <img src="img/delete.png" width="15"> </a> | 
	...
	<form action="update_tutionc2.php" method="post">
		...
		<div class="modal-content">
		  ...
		  <div class="modal-body mx-3">
			<div class="md-form mb-5">
				...
				<select name="cat_name" id="defaultForm-email" class="form-control" required="required" style="width: 98%;" >
			...
			<div class="md-form mb-5">
			  <label data-error="wrong" data-success="right" for="defaultForm-email">Subject Name</label>
			  <input type="text" id="defaultForm-email" class="form-control tt" name="sub_name" value="<?php echo $sub_name; ?>">
			</div>
		  </div>
