        ...
        <div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-lg-12 col-xl-12">
					<div class="">
						<h1 class="font-weight-bold mt-5" style="font-size:20px;"><font class="font-1">View</font><font class="font-2">&nbsp;Tution Report</font></h1>
						<p>Internship</p>
					</div>
				</div>
				<!--./head-->
...
<?php $page_name="viewreport_tution.php"; /*/  If you use this code with a different page ( or file ) name then change this*/ 
...
?> 
										<tbody>
											<tr> 
												...
												<td><span ><?php echo $cat_name2; ?></span></td>
												<td><span ><?php echo $city; ?></span></td>
												<td><span ><?php echo $sub_name2; ?></span></td>
											</tr>
										</tbody>
									<?php
								$j++;	}
