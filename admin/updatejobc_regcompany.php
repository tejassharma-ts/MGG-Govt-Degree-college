...
<?php 
$id = $_GET['id'];
$q = "select * from cjobreg_tb where id='$id' ";
...
if(isset($_POST['post']))
{
	...
	if (!empty($_FILES['image']['name'])) {
		...
		mysqli_query($con,"UPDATE `cjobreg_tb` SET  `orgname`='".$orgname."',`img_path`='".$img_name."',`email`='".$email."',`fname`='".$fname."',`lname`='".$lname."',`current_city`='".$current_city."',`current_state`='".$current_state."',`mobile`='".$mobile."',`mobile2`='".$mobile2."',`mobile3`='".$mobile3."',`cwebsite`='".$cwebsite."' WHERE id='$id' ");
	
	header("location:viewjobc_regcompany.php?u=1");
	//echo "<span style='color:red;font-size:25px;'>Register Company Successfully Updated</span>";
	} else {
		mysqli_query($con,"UPDATE `cjobreg_tb` SET  `orgname`='".$orgname."',`email`='".$email."',`fname`='".$fname."',`lname`='".$lname."',`current_city`='".$current_city."',`current_state`='".$current_state."',`mobile`='".$mobile."',`mobile2`='".$mobile2."',`mobile3`='".$mobile3."',`cwebsite`='".$cwebsite."' WHERE id='$id' ");
        ...
        <div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-lg-12 col-xl-12">
					<div class="">
						<h1 class="font-weight-bold mt-5" style="font-size:20px;"><font class="font-1">Update</font><font class="font-2">&nbsp;Job Registered Company</font></h1>
						<p>Internship Time </p>
					</div>
				</div>
				<!--./head-->
				<div class="col-lg-12 col-xl-12">
					<div class="box-1">
						<div class="box-2">
							...
							<div class="box-3"><a href="viewjobc_company_details.php?id=<?php echo $id;?>" class="btn btn-primary">Back</a>
