        ...
        <div class="container">
            <div class="row">
                <div class="page-title-wrap2 text-center w-100">
                    <h1 class="page-title-captions2"><b>Our Committee</b> </h1>
        ...
        <div class="container">
            <div class="row d-flex justify-content-space-between" style="justify-content: space-between;">
                <div class="col-md-12 col-lg-7 col-sm-12 col-12">
                    <h3><b>Our Committee </b></h3>
                    <hr style="background-color: red;" class="mt-0 mb-3">
                    <p>Our committee, the Mahayogi Guru Gorakhnath Education Committee, stands as a beacon of
                        educational empowerment in the Yamkeshwar Vidhan Sabha constituency. Established in 1998, our
                        mission revolves around bridging the educational gap and fostering access to higher learning
                        opportunities for students residing in the Yamkeshwar, Dugadda, and Dwarikhal development areas.
                        Through diligent efforts, we successfully spearheaded the establishment of the Mahayogi Guru
                        Gorakhnath Government College in the village of Bithyani, a testament to our commitment to
                        educational advancement.</p>
                    <br>
                    <p>Driven by the ethos of service and community support, our committee has garnered widespread
                        acclaim for its endeavors. We have facilitated the acquisition of 165 acres of land from
                        generous land donors in the villages of Bithyani, Munjra, Maletha, and Umroli, laying the
                        foundation for a transformative educational institution. Since its inception in 2005, the
                        college has become synonymous with excellence, continually enhancing the quality of education it
                        offers.</p>
                    <br>
                    <p>Today, as a state-owned institution, the Mahayogi Guru Gorakhnath Government College remains
                        dedicated to nurturing academic excellence and shaping the leaders of tomorrow. Our committee's
                        unwavering dedication, coupled with the invaluable support of the local community and the
                        visionary guidance of esteemed leaders such as Mahant Avaidyanath Ji Maharaj and Mahant Shri
                        Yogi Adityanath Ji, has been instrumental in our journey towards educational empowerment.</p>
